...
#Formulate and perform DEA analysis under all DEA assumptions FDH, CRS,VRS,IRS,DRS and FRH. Determine Peers and Lambdas under each of the above assumption
...
a) Inefficient peers will have peers and lambda weights whereas, efficient peers will not have peers and lambda weights.
b) DEA is a benchmarking tool that evaluates a population of DMUs in their performance in converting input to outputs.
